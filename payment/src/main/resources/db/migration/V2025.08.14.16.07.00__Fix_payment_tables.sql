ALTER TABLE payments
    ...
    ADD COLUMN requested_amount   BIGINT       NOT NULL COMMENT '요청 금액',
    ADD COLUMN approved_amount    BIGINT       NOT NULL COMMENT '승인 금액',
    ADD COLUMN refunded_amount    BIGINT       NOT NULL COMMENT '환불 금액',
