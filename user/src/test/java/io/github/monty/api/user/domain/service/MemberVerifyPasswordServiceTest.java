...
class MemberVerifyPasswordServiceTest {
    ...
    void verifyPassword_success() {
        ...
        //  when,   then
        assertDoesNotThrow(() -> memberVerifyPasswordService.verifyPassword("testLoginId", "testPassword"));
    }
    ...
    void verifyPassword_fail_not_found_userInfo() {
        //  when
        ApplicationException actual = assertThrows(ApplicationException.class, () -> memberVerifyPasswordService.verifyPassword("testLoginId", "testPassword!"));
        assertAll(
